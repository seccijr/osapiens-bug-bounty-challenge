...
const useMatchedRoute = (
    ...
    const Transition: React.FC<{ match: any }> = React.useMemo(() => {
        if (transition === 'fade') {
            const FadeTransition: React.FC<{ match: any }> = ({ children, match }) => (
        ...
        if (transition === 'grow') {
            const GrowTransition: React.FC<{ match: any }> = ({ children, match }) => (
        ...
        if (transition.startsWith('slide')) {
            ...
            const SlideTransition: React.FC<{ match: any }> = ({ children, match }) => (
                <Slide
                    in={match ? true : false}
